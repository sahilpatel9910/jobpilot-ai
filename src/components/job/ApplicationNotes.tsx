    ...
    <section className="rounded-lg border border-slateLine bg-white p-5 shadow-soft">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Track recruiter details, follow-ups, interview notes, and next actions.</p>
        </div>
        <button
          type="button"
          onClick={saveNotes}
      ...
      <textarea
        ...
        placeholder="Add follow-up dates, recruiter names, interview prep notes, or anything you need to remember."
